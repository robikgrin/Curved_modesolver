...
# ЦЕЛЕВАЯ ФУНКЦИЯ
U_target = dft(N_modes) / np.sqrt(N_modes)  # Нормированный DFT для N_modes
...
# =====================================================================
initial_guess = 0.05 * np.sin(np.linspace(0, 4 * np.pi, N_points))  # Случайные кривизны в безопасном диапазоне
...
ax1.set_title('Inverse Designed DFT Interferometer', fontsize=16, pad=15)
